...
public class SuccursaleList extends ArrayAdapter<Succursale> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewHoraire = (TextView) listViewItem.findViewById(R.id.textViewHour);
        Succursale succursale = succursales.get(position);
        textViewSuccursaleName.setText(succursale.getAddressName());
        textViewHoraire.setText(succursale.getHoraire());
        return listViewItem;
    }
}
