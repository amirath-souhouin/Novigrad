...
public class ServiceList extends ArrayAdapter<Service> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewServiceName = listViewItem.findViewById(R.id.textViewServiceName);
        TextView textViewDocuments = listViewItem.findViewById(R.id.textViewDocuments);
